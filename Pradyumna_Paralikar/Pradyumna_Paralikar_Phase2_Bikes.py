...
df = pd.read_csv('/Users/pparalik/Downloads/mltrainingv1-master/decision-tree/bikes.csv')
...
clf = make_pipeline(PolynomialFeatures(degree=2), Ridge())
clf.fit(X_train, Y_train)
...
clf = make_pipeline(PolynomialFeatures(degree=4), Lasso())
clf.fit(X_train, Y_train)
